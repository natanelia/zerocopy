...
const BrandedValue = json<{ id: Id }>();
type BrandedRead = Assert<Equal<ValueOf<typeof BrandedValue>, { readonly id: Id }>>;
type BrandedArray = Assert<Equal<DeepReadonly<Id[]>, readonly Id[]>>;
type BrandedNumber = number & { readonly [idBrand]: true };
type BrandedNumberRead = Assert<Equal<DeepReadonly<BrandedNumber>, BrandedNumber>>;
void wire;
